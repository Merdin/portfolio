...
using FrontEnd.AutomaticTokenManagement;
...
namespace FrontEnd.OAuth
{
    public static class KeycloakExtensions
    {
        ...
        private static void ApplyDefaultKeycloakConfiguration(OpenIdConnectOptions options)
        {
            ...
            options.Events = new OpenIdConnectEvents
            {
                OnTokenValidated = context =>
                {
                    ...
                    MapStudyM8RolesToRoleClaims(context);
        ...
        private static void MapKeycloakRolesToRoleClaims(TokenValidatedContext context)
        {
            ...
            var clientResource = resourceAccess["account"];
        ...
        private static void MapStudyM8RolesToRoleClaims(TokenValidatedContext context)
        {
            var resourceAccess = JObject.Parse(context.Principal.FindFirst("realm_access").Value);
